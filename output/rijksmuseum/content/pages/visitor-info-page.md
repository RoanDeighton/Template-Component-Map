...
5. **[Scroll-Driven Image Carousel](../components/scroll-driven-carousel.md)**: second instance, a rotating visitor-testimonial/quote carousel (5-star reviews, e.g. Google Reviews) with a play button, suggesting embedded video testimonials, and pagination. The specific quote shown changes between visits/captures since it rotates.
